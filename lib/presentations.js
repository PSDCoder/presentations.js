(function ($, undefined) {
    ...
    Presentation.prototype.bindHandlers = function () {
        this.$presentation.on('click.' + namespace, function () {
    ...
    Presentation.prototype.buildArrows = function () {
        ...
        this.cached.$arrowPrevious.on('click.' + namespace, function (e) {
            e.preventDefault();
            this.showPrevious();
        }.bind(this));

        this.cached.$arrowNext.on('click.' + namespace, function (event) {
            event.preventDefault();
            this.showNext();
        }.bind(this));
    };
